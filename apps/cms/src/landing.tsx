  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans selection:bg-cyan-500/30">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4">
        <nav className={`transition-all duration-300 rounded-full px-4 md:px-6 py-3 flex items-center justify-between w-full max-w-5xl ${isScrolled ? "glass-nav shadow-[0_8px_32px_rgba(0,0,0,0.5)] border border-white/10" : "bg-transparent border border-transparent"}`}>
          ...
          <div className="hidden md:flex items-center gap-8 text-xs font-semibold tracking-wide uppercase text-zinc-400">
            ...
            <a href="https://github.com/ij-roy/Ilm" target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-2">
              <Github className="w-4 h-4" /> Open Source
            </a>
          </div>
          <div>
            <Button onClick={onConnectGitHub} className="bg-white text-black hover:bg-zinc-200 h-9 px-5 py-0 text-xs uppercase tracking-wide font-bold rounded-full shadow-[0_0_15px_rgba(255,255,255,0.2)] hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-all">
              Get Started
            </Button>
          </div>
        </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up" style={{ animationDelay: "200ms" }}>
            Ilm is a Git-native, database-free CMS that writes portable Markdown directly to your GitHub repository. Your content, completely under your control.
          </p>
      ...
      <section id="features" className="py-24 px-6 relative z-10 bg-black">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">A powerful writing experience that respects your ownership.</p>
          </div>
      ...
      {/* How it Works */}
      <section id="how-it-works" className="py-24 px-6 relative z-10 bg-black/50 border-t border-white/5">
      ...
      <footer className="border-t border-white/10 bg-black py-12 px-6">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm text-zinc-500">
            <a href="https://github.com/ij-roy/Ilm" className="hover:text-white transition-colors">GitHub</a>
...
function FeatureCard({ icon, title, description }: { readonly icon: ReactNode, readonly title: string, readonly description: string }) {
  return (
...
function Step({ number, title, description }: { readonly number: string, readonly title: string, readonly description: string }) {
  return (
...
function SparkleIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L14.2 8.5L20.7 10.7L14.2 12.9L12 19.4L9.8 12.9L3.3 10.7L9.8 8.5L12 2Z" fill="currentColor"/>
    </svg>
  );
}
